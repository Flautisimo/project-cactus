export default function About () {
  return (
    <section data-aos='fade-left' data-aos-duration='2000' id='About'>
      <div className='Container relative min-h-screen md:h-48 mt-32 bg-gradient-to-b from-transparent to-white via-gray-200 p-10 md:px-48'>
        <div className='space-y-10 md:space-y-0 md:grid md:grid-cols-2'>
          ...
          <div className='font-body md:flex md:flex-col md:pt-16 justify-center'>
            ...
            <button className='block mt-6 md:ml-8 w-full md:w-4/12 font-body font-bold bg-blue-400 hover:bg-gray-500 p-3 md:p-4 rounded text-indigo-900 hover:text-white transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 ... uppercase'>
              My Portfolio
            </button>
          </div>
